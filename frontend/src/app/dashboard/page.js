            ...
            {applications.length === 0 ? (
              <div className="bg-white rounded-2xl border border-gray-100 p-12 text-center">
                ...
                <p className="text-gray-400 text-sm mb-6">
                  Start by browsing universities and programs
                </p>
                <Link
                  href="/universities"
                      ...
                      <div className="flex items-start justify-between gap-4">
                        <div className="flex-1">
                          <div className="flex items-center gap-2 mb-1">
                            <span
                              className={`text-xs font-semibold px-3 py-1 rounded-full flex items-center gap-1 ${status.color}`}
                            >
                              <StatusIcon size={12} />
                              {status.label}
                            </span>
                          ...
                          <p className="text-gray-500 text-sm">
                            {app.university_name} · {app.university_country}
                          </p>
                          <div className="flex gap-4 mt-2 text-xs text-gray-400">
                            ...
                            {app.tuition_fee && (
                              <span>
                                ${app.tuition_fee.toLocaleString()}/yr
                              </span>
                            )}
                          </div>
                          {app.notes && (
